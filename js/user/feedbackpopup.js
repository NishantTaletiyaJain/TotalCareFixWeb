...
//     // Update star icons based on rating input
...
// // Function to update star rating based on the selected rating
// function updateStarRating(container, rating) {
//     container.innerHTML = ''; // Clear previous stars

//     for (var i = 0; i < 5; i++) {
//         var starIcon = document.createElement('i');
//         starIcon.className = 'fas fa-star'; // Assuming you're using Font Awesome for star icons
//         if (i >= rating) {
//             starIcon.style.color = '#ccc'; // Gray out remaining stars
//         }
